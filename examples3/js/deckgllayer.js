 ...
 */
    ...
    constructor(layerTypeID, options) {
        ...
        /**
         * @member {string} mapboxgl.DeckglLayer.prototype.id
         * @description 高效率点图层 id。
         */
        this.layerTypeID = layerTypeID;
        /**
         * @member {Array.<mapboxgl.Graphic>} mapboxgl.DeckglLayer.prototype.graphics 
         * @description 点要素对象数组。
         */
        ...
        this.id = options.layerId ? options.layerId : this.createUniqueID("graphicLayer_" + this.layerTypeID + "_");

        /**
         * @member {boolean} [mapboxgl.DeckglLayer.prototype.visibility=true]
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype.onAdd
     * @param {mapboxgl.Map} map - Mapbox GL 地图对象。
     * @returns {mapboxgl.DeckglLayer}
     */
    onAdd(map) {
        this.map = map;
        if (this.canvas) {
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype.remove
     * @description 删除该图层。
     */
    remove() {
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype.removeFromMap
     * @deprecated
     * @description 删除该图层。
     */
    removeFromMap() {
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype.moveTo
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype.setVisibility
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype.setStyle
    ...
    setStyle(styleOptions) {
        this.getextend(this.props, styleOptions);
        this.update();
    }
    /**
     * @function mapboxgl.DeckglLayer.prototype.setData
    ...
    setData(data) {
        this.data = this.data || [];
        this.data.length = 0;
        let dataTemp = !this.isArray(data) ? [data] : [].concat(data);
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype.addData
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype.update
     * @description 更新图层。
     */
    update() {
        let changeFlags = {
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype.clear
     * @description 释放图层资源。
     */
    // todo 还有哪些资源应该被释放？
    clear() {
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype.removeData
     * @description 移除所有要素。
     */
    removeData() {
        this.data.length = 0;
    ...
    /**
     * @function mapboxgl.DeckglLayer.prototype._createLayerByLayerTypeID
...
mapboxgl.DeckglLayer = DeckglLayer;