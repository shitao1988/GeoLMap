 ...
 */
    ...
    L.Draw.Textbox = L.Draw.Rectangle.extend({
        statics: {
            TYPE: 'textbox'
        },
        ...
        initialize: function(map, options) {
            ...
            this.type = L.Draw.Textbox.TYPE;
        },

        _fireCreatedEvent: function() {
            var latlngs = this._shape.getLatLngs()[0],
            ...
            var textbox = new L.Textbox(center, this.options.textOptions)
    ...
    L.Pointer = L.Path.extend({
        ...
        _updatePath: function() {
            ...
            this._renderer._updatePath.call(this);
        }
    });
    L.Pointer = L.Pointer.extend({
    ...
    L.Textbox = L.RotatableMarker.extend({
        statics: {
            TYPE: 'textbox',
        ...
        initialize: function(latlng, options) {
            options.icon = new L.DivIcon({
                className: 'leaflet-textbox-container',
        ...
        onAdd: function(map) {
            ...
            for (var i = 0; i < L.Textbox.TEXTEDIT_EVENTS.length; i++) {
                editevent = L.Textbox.TEXTEDIT_EVENTS[i];
        ...
        _enableTyping: function() {
            ...
            this._selecting = new L.Selectable(textarea);
        ...
        _showIfEmpty: function(event) {
            ...
            if (text === '') {
                L.DomUtil.addClass(textarea, 'leaflet-textbox-empty');
            } else {
                L.DomUtil.removeClass(textarea, 'leaflet-textbox-empty');
            }
        },
        ...
        _addClasses: function() {
            ...
            L.DomUtil.addClass(textarea, 'leaflet-textbox');
    ...
    L.Textbox.prototype.toGeoJSON = function() {
        var size = this.getSize(),
            properties = {
    ...
    L.textbox = function(latlng, options) {
        return new L.Textbox(latlng, options);
    };
    ...
    L.Edit.Textbox = L.Edit.SimpleShape.extend({
        addHooks: function() {
        ...
        _addRotateHandle: function() {
            this._rotateHandle = new L.RotateHandle(this._shape, {
        ...
        _addMoveHandle: function() {
            this._moveHandle = new L.MoveHandle(this._shape, {
        ...
        _addResizeHandles: function() {
            var size = this._shape.getSize(),
                ...
                upperLeft = new L.ResizeHandle(this._shape, {
                    offset: new L.Point(-width, -height),
                    corner: 'upper-left'
                }),
                upperRight = new L.ResizeHandle(this._shape, {
                    offset: new L.Point(width, -height),
                    corner: 'upper-right'
                }),
                lowerLeft = new L.ResizeHandle(this._shape, {
                    offset: new L.Point(-width, height),
                    corner: 'lower-left'
                }),
                lowerRight = new L.ResizeHandle(this._shape, {
                    offset: new L.Point(width, height),
                    corner: 'lower-right'
                });
    ...
    L.Textbox.addInitHook(function() {
        /*  if (L.Edit.Textbox) {
             this.editing = new L.Edit.Textbox(this);
    ...
    L.MoveHandle = L.EditHandle.extend({
        options: {
            TYPE: 'move'
        },
    ...
    L.PointerHandle = L.EditHandle.extend({
        initialize: function(shape, options) {
            L.EditHandle.prototype.initialize.call(this, shape, options);
        ...
        _unbindListeners: function() {
            L.EditHandle.prototype._unbindListeners.call(this);
    ...
    L.ResizeHandle = L.EditHandle.extend({
        options: {
            TYPE: 'resize'
        },
        ...
        updateHandle: function() {
            ...
            L.EditHandle.prototype.updateHandle.call(this);
        }
    });
    L.RotateHandle = L.EditHandle.extend({
        ...
        onAdd: function(map) {
            L.EditHandle.prototype.onAdd.call(this, map);
        ...
        _createPointer: function() {
            ...
            this._pointer = new L.Pointer(this._handled.getLatLng(), [], options);
            this._updatePointer();
    ...
    L.DrawToolbar = L.Toolbar.extend({
        ...
        getModeHandlers: function(map) {
            return [{
                    ...
                    handler: new L.Draw.Textbox(map, this.options.textbox),
                    title: 'Add a textbox'
                },
                {
