/* globals L.Terraformer */
(function(root, factory) {

    // Node.
    if (typeof module === 'object' && typeof module.exports === 'object') {
        exports = module.exports = factory(require('L.Terraformer'));
    }

    // Browser Global.
    if (typeof root.navigator === "object") {
        if (!root.L.Terraformer) {
            throw new Error("L.Terraformer.ArcGIS requires the core L.Terraformer library");
        }
        root.L.Terraformer.ArcGIS = factory(root.L.Terraformer);
    }
